...
# 이론적 타당성(독립성) 확인, 독립변수 대상 변수들은 서로 간에 독립적 이어야 함.
# 독립변수 대상 변수들은 다중공선성이 발생할 수 있는데 이를 확인 
...
print()
print(df.corr())
print(df.corr(method='pearson'))    # 변수가 등간, 비율. 정규성 따름
print(df.corr(method='spearman'))   # 서열척도, 정규성 X
